...
public class SaturationFragment extends ListFragment {
    ...
    public static final String SAT_SWATCH_COUNT_PREF = "SatSwatchCount";
...
//        if (DEBUG) Log.i(TAG, "onAttach(Activity)");
    ...
    public void onViewCreated( View view, Bundle savedInstanceState ) {
        ...
        mSwatchCount = getActivity().getPreferences( Context.MODE_PRIVATE )
                .getInt( SAT_SWATCH_COUNT_PREF, 8 );
        mColorList = SwatchHelper.createSatSwatches( mSwatchCount, mCallbacks.getSwatch() );
    ...
    public void onListItemClick( ListView listView,
        ...
        mCallbacks.selectSaturation( mAdapter.getSwatch( position ) );
    }
    ...
    private void savePrefs(){
        ...
        editor.putInt( SAT_SWATCH_COUNT_PREF, mSwatchCount );
        editor.apply();
    }
    /**
